...
const char * rtTextUtil::RT_STD_FONT = "DejaVuSans.ttf";

TTF_Font * rtTextUtil::RT_LARGE_FONT = NULL;
TTF_Font * rtTextUtil::RT_MEDIUM_FONT = NULL;
TTF_Font * rtTextUtil::RT_SMALL_FONT = NULL;

SDL_Surface * rtTextUtil::render(const char * text, SDL_Color color, TTF_Font * font, bool bold, bool italic) {
...
std::string rtTextUtil::splitString(std::string & str, char delim) {
